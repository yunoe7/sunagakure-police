 ...
 *  - "👤 Mon profil" : page profil personnel
 *  - "🔄 Refresh mes rôles" : force le refetch des rôles Discord
 *  - "🚪 Déconnexion" : logout
 *
 * Badges : voir composant UserBadges (rang, branches, clan, rôles spéciaux, etc.)
 */
        ...
        <div className={styles.footer}>
          ...
          >
            ...
            <div className={styles.userInfo} style={{ minWidth: 0, flex: 1 }}>
              ...
              {/* 🎨 Badges via composant réutilisable */}
              {u.isLoading ? (
                <div className={styles.urank}>…</div>
              ) : u.user ? (
                <div style={{ marginTop: 3 }}>
                  <UserBadges user={u.user} size="sm" />
                </div>
              ) : (
            ...
            {userMenuOpen && (
              ...
              >
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = 'rgba(212, 172, 13, 0.08)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = 'transparent';
                  }}
                  title="Voir mon profil et mon activité"
                >
                  <Icons.User size={14} />
                  Mon profil
                </button>

                <div style={{ height: 1, background: 'rgba(212, 172, 13, 0.15)' }} />
